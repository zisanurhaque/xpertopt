const commonSecData = {
    ...
    desc: [
        ...
        "Most of the triggers for a listing suppression or suspension are out of your control and are generally triggered by external factors. When this inevitable situation arises during your Amazon selling journey, individual and very specific actions need to be taken to resolve this issue to avoid substantial financial losses and negative brand reputation. For those lucky enough to have avoided this, it becomes a frantic stressful struggle to put all the pieces together when it does happen. We can help you at Seller Interactive."
    ],
    image: "/sec1.webp"
}
